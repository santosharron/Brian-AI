...
const TaskUI = () => {
  ...
  return (
    <>
      <Textarea
        autoFocus
        placeholder="Brian uses OpenAI's GPT-4 API to perform actions on the current page. Try telling it to sign up for a newsletter, or to add an item to your cart."
